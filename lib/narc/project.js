...
exports.Project = function(db, callback) {
  ...
  var Project = Pattern.extend({
    ...
    get: function(id, callback) {
      var self = this;
      // console.log('Project#get(%s)', id);
      // console.log('Project#get(%s)', ObjectID.createFromHexString(id));
      ...
      // console.log('findOne(%s)', util.inspect({'slug': id}));
      // console.log('_collection: %s', util.inspect(self));
      // console.log('_collection: %s', util.inspect(self._collection));
      self._collection.findOne({ 'slug': id }, function(error, project) {
        // console.log('Error: %s', error);
        if (project === undefined || project === null) {
          // console.log('Project not found by slug, trying by _id');
          self._collection.findOne({ '_id': ObjectID.createFromHexString(id) }, function(error, project) {
            // console.log('Error: %s', error);
            // console.log('Got one! %s', project);
